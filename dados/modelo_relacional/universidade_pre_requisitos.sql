...
CREATE TABLE `pre_requisitos` (
  `idPre_requisitos` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `pre_requisitos` VALUES (1,'Introdução à Computação'),(2,'Lógica de Programação'),(3,'Matemática Básica'),(4,'Fundamentos de Administração'),(5,'Metodologia Científica');
