...
CREATE TABLE `dimdepartamento` (
  `DepartamentoKey` int NOT NULL AUTO_INCREMENT,
  `DepartamentoID` int NOT NULL,
  `NomeDepartamento` varchar(45) NOT NULL,
  `Campus` varchar(45) NOT NULL,
  PRIMARY KEY (`DepartamentoKey`)
...
INSERT INTO `dimdepartamento` VALUES (1,1,'Tecnologia da Informação','Campus Centro'),(2,2,'Administração','Campus Centro'),(3,3,'Engenharia','Campus Norte'),(4,4,'Ciências Humanas','Campus Sul');
